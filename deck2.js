...
function roundOutput(player1, player2, roundNum) {
    console.log("==============================================");
    let roundCount = roundNum + 1;
    console.log(`               Round: `+ roundCount);
    console.log("==============================================");
    console.log(`       ${player1.name} plays: [${player1.playerDeck[roundNum].value} ${player1.playerDeck[roundNum].suit}]
    `);
    console.log(`           ${player2.name} plays: [${player2.playerDeck[roundNum].value} ${player2.playerDeck[roundNum].suit}]
    `);
    console.log("==============================================");
  }
...
function playRoundResults(player1, player2) {
  ...
  for (let i = 0; i < player1.playerDeck.length; i++) {
    ...
    if (cardValueMap[player1.playerDeck[i].value] > cardValueMap[player2.playerDeck[i].value]) {
      ...
      console.log("----------------------------------------------");
      console.log(`         Current score: ${player1.name} ${player1.playerScore}`);
      console.log(`         Current score: ${player2.name} ${player2.playerScore}`);
      //console.log("==============================================");
      console.log("----------------------------------------------");
...
function finalTally(player1, player2) {
  if (player1.playerScore > player2.playerScore) {
    ...
    console.log("==============================================");
    console.log("----------------------------------------------");
    console.log(`${player1.name} has won this game! Final score of: ${player1.playerScore}`);
    console.log(`${player2.name} has lost this game! Final score of: ${player2.playerScore}`);
  } else if (player1.playerScore < player2.playerScore) {
    console.log("           FINAL RESULTS!!!");
    console.log("==============================================");
    console.log("----------------------------------------------");
    console.log(`${player2.name} has won this game! Final score of: ${player2.playerScore}`);
    console.log(`${player1.name} has lost this game! Final score of: ${player1.playerScore}`);
  } else {
    console.log("           FINAL RESULTS!!!");
    console.log("==============================================");
    console.log("----------------------------------------------");
